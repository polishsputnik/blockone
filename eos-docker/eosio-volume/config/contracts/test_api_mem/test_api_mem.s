...
apply:
	...
	i32.const	$push92=, 160
	i32.sub 	$push142=, $pop91, $pop92
	tee_local	$push141=, $7=, $pop142
	i32.store	__stack_pointer($pop93), $pop141
	...
	block   	
	block   	
	i64.const	$push0=, 7792854415333171755
	i64.gt_s	$push1=, $2, $pop0
	br_if   	0, $pop1
	i64.const	$push16=, -8214783466807040678
	i64.gt_s	$push17=, $2, $pop16
	br_if   	1, $pop17
	i64.const	$push24=, -8214783469575734291
	i64.eq  	$push25=, $2, $pop24
	br_if   	3, $pop25
	i64.const	$push26=, -8214783469185548223
	i64.eq  	$push27=, $2, $pop26
	br_if   	4, $pop27
	i64.const	$push28=, -8214783468056823579
	i64.ne  	$push29=, $2, $pop28
	br_if   	11, $pop29
	i32.const	$push74=, 983040
	i32.call	$push75=, _Z4sbrkj@FUNCTION, $pop74
	i32.const	$push76=, 65536
	i32.eq  	$push77=, $pop75, $pop76
	i32.const	$push78=, .L.str.13
	call    	eosio_assert@FUNCTION, $pop77, $pop78
	i32.const	$push79=, 0
	i32.call	$push80=, _Z4sbrkj@FUNCTION, $pop79
	i32.const	$push81=, 1048576
	i32.eq  	$push82=, $pop80, $pop81
	i32.const	$push143=, .L.str.13
	call    	eosio_assert@FUNCTION, $pop82, $pop143
	i32.const	$push83=, 1
	i32.call	$push84=, _Z4sbrkj@FUNCTION, $pop83
	i32.const	$push85=, -1
...
.LBB16_6:
	end_block
	i64.const	$push2=, 7792854416780467198
	i64.gt_s	$push3=, $2, $pop2
	br_if   	1, $pop3
	i64.const	$push10=, 7792854415333171756
	i64.eq  	$push11=, $2, $pop10
	br_if   	4, $pop11
	i64.const	$push12=, 7792854415767337072
	i64.eq  	$push13=, $2, $pop12
	br_if   	5, $pop13
	i64.const	$push14=, 7792854416736093147
...
.LBB16_11:
	end_block
	i64.const	$push18=, -8214783466807040677
	i64.eq  	$push19=, $2, $pop18
	br_if   	5, $pop19
	i64.const	$push20=, 7792854414681016814
	i64.eq  	$push21=, $2, $pop20
	br_if   	6, $pop21
	i64.const	$push22=, 7792854415331153655
	i64.ne  	$push23=, $2, $pop22
	br_if   	9, $pop23
	i32.const	$push97=, 48
	i32.add 	$push98=, $7, $pop97
	i32.const	$push31=, 4
	i32.add 	$push32=, $pop98, $pop31
	i32.const	$push30=, 0
	i32.load16_u	$push162=, .L_ZZN11test_memory11test_memcmpEvE4buf6+4($pop30):p2align=0
	tee_local	$push161=, $3=, $pop162
	i32.store16	0($pop32), $pop161
	i32.const	$push160=, 0
	i32.load	$push159=, .L_ZZN11test_memory11test_memcmpEvE4buf6($pop160):p2align=0
	tee_local	$push158=, $4=, $pop159
	i32.store	48($7), $pop158
	i32.const	$push99=, 40
	i32.add 	$push100=, $7, $pop99
	i32.const	$push157=, 4
	i32.add 	$push33=, $pop100, $pop157
	i32.store16	0($pop33), $3
	i32.store	40($7), $4
	...
	i32.const	$push34=, 6
	i32.call	$push35=, memcmp@FUNCTION, $pop102, $pop104, $pop34
	i32.eqz 	$push36=, $pop35
	i32.const	$push37=, .L.str.69
	call    	eosio_assert@FUNCTION, $pop36, $pop37
	i32.const	$push105=, 32
	i32.add 	$push106=, $7, $pop105
	i32.const	$push156=, 4
	i32.add 	$push38=, $pop106, $pop156
	i32.store16	0($pop38), $3
	i32.store	32($7), $4
	i32.const	$push107=, 24
	i32.add 	$push108=, $7, $pop107
	i32.const	$push155=, 4
	i32.add 	$push39=, $pop108, $pop155
	i32.const	$push154=, 0
	i32.load16_u	$push153=, .L_ZZN11test_memory11test_memcmpEvE4buf5+4($pop154):p2align=0
	tee_local	$push152=, $5=, $pop153
	i32.store16	0($pop39), $pop152
	i32.const	$push151=, 0
	i32.load	$push150=, .L_ZZN11test_memory11test_memcmpEvE4buf5($pop151):p2align=0
	tee_local	$push149=, $6=, $pop150
	i32.store	24($7), $pop149
	i32.const	$push109=, 32
	i32.add 	$push110=, $7, $pop109
	i32.const	$push111=, 24
	i32.add 	$push112=, $7, $pop111
	i32.const	$push148=, 6
	i32.call	$push40=, memcmp@FUNCTION, $pop110, $pop112, $pop148
	i32.const	$push41=, 31
	i32.shr_u	$push42=, $pop40, $pop41
	i32.const	$push43=, .L.str.70
	call    	eosio_assert@FUNCTION, $pop42, $pop43
	i32.const	$push113=, 16
	i32.add 	$push114=, $7, $pop113
	i32.const	$push147=, 4
	i32.add 	$push44=, $pop114, $pop147
	i32.store16	0($pop44), $5
	i32.store	16($7), $6
	i32.const	$push115=, 8
	i32.add 	$push116=, $7, $pop115
	i32.const	$push146=, 4
	i32.add 	$push45=, $pop116, $pop146
	i32.store16	0($pop45), $3
	i32.store	8($7), $4
	i32.const	$push117=, 16
	i32.add 	$push118=, $7, $pop117
	i32.const	$push119=, 8
	i32.add 	$push120=, $7, $pop119
	i32.const	$push145=, 6
	i32.call	$push46=, memcmp@FUNCTION, $pop118, $pop120, $pop145
	i32.const	$push144=, 0
	i32.gt_s	$push47=, $pop46, $pop144
	i32.const	$push48=, .L.str.71
	call    	eosio_assert@FUNCTION, $pop47, $pop48
	br      	10
.LBB16_15:
	end_block
	i64.const	$push4=, 7792854416780467199
	i64.eq  	$push5=, $2, $pop4
	br_if   	6, $pop5
	i64.const	$push6=, 7792854416965679705
	i64.eq  	$push7=, $2, $pop6
	br_if   	7, $pop7
	i64.const	$push8=, 7792854417135312106
	i64.ne  	$push9=, $2, $pop8
	br_if   	8, $pop9
	i32.const	$push65=, 983036
	i32.call	$push66=, malloc@FUNCTION, $pop65
	i32.const	$push67=, 0
	i32.ne  	$push68=, $pop66, $pop67
	i32.const	$push69=, .L.str.45
...
.LBB16_22:
	...
	i32.const	$push58=, 0
	i32.const	$push57=, 99
	i32.call	$drop=, memset@FUNCTION, $pop122, $pop58, $pop57
	i32.const	$push123=, 48
	i32.add 	$push124=, $7, $pop123
	i32.const	$push60=, 238
	i32.const	$push59=, 50
	i32.call	$drop=, memset@FUNCTION, $pop124, $pop60, $pop59
	i32.const	$push125=, 48
	i32.add 	$push126=, $7, $pop125
	i32.const	$push165=, 50
	i32.add 	$push61=, $pop126, $pop165
	i32.const	$push63=, 255
	i32.const	$push62=, 49
	i32.call	$drop=, memset@FUNCTION, $pop61, $pop63, $pop62
	i32.const	$push127=, 48
	i32.add 	$push128=, $7, $pop127
	i32.const	$push164=, 49
	i32.add 	$push64=, $pop128, $pop164
	i32.const	$push129=, 48
	i32.add 	$push130=, $7, $pop129
	i32.const	$push163=, 50
	i32.call	$drop=, memcpy@FUNCTION, $pop64, $pop130, $pop163
	br      	5
.LBB16_23:
	end_block
	i32.const	$push70=, -1
	i32.call	$push71=, _Z4sbrkj@FUNCTION, $pop70
	i32.const	$push166=, -1
	i32.eq  	$push72=, $pop71, $pop166
	i32.const	$push73=, .L.str.15
...
.LBB16_25:
	...
	i32.const	$push50=, 0
	i32.const	$push49=, 99
	i32.call	$drop=, memset@FUNCTION, $pop132, $pop50, $pop49
	i32.const	$push133=, 48
	i32.add 	$push134=, $7, $pop133
	i32.const	$push52=, 238
	i32.const	$push51=, 50
	i32.call	$drop=, memset@FUNCTION, $pop134, $pop52, $pop51
	i32.const	$push135=, 48
	i32.add 	$push136=, $7, $pop135
	i32.const	$push169=, 50
	i32.add 	$push53=, $pop136, $pop169
	i32.const	$push55=, 255
	i32.const	$push54=, 49
	i32.call	$drop=, memset@FUNCTION, $pop53, $pop55, $pop54
	i32.const	$push139=, 48
	i32.add 	$push140=, $7, $pop139
	i32.const	$push137=, 48
	i32.add 	$push138=, $7, $pop137
	i32.const	$push168=, 49
	i32.add 	$push56=, $pop138, $pop168
	i32.const	$push167=, 50
	i32.call	$drop=, memcpy@FUNCTION, $pop140, $pop56, $pop167
	br      	2
.LBB16_26:
	end_block
...
.LBB17_7:
	...
	.endfunc
.Lfunc_end17:
	.size	_Z4sbrkj, .Lfunc_end17-_Z4sbrkj
...
realloc:
	...
	.endfunc
.Lfunc_end21:
	.size	realloc, .Lfunc_end21-realloc
...
.LBB22_28:
	...
	.endfunc
.Lfunc_end22:
	.size	_ZN5eosio14memory_manager7reallocEPvm, .Lfunc_end22-_ZN5eosio14memory_manager7reallocEPvm
...
.LBB23_19:
	...
	.endfunc
.Lfunc_end23:
	.size	_ZN5eosio14memory_manager6memory16realloc_in_placeEPcmPm, .Lfunc_end23-_ZN5eosio14memory_manager6memory16realloc_in_placeEPcmPm
