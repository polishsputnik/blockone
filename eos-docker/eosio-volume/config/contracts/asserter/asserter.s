...
apply:
	...
	i32.sub 	$push71=, $pop62, $pop63
	tee_local	$push70=, $9=, $pop71
	i32.store	__stack_pointer($pop64), $pop70
...
.LBB2_1:
	...
	block   	
	i64.const	$push72=, 7
	i64.gt_u	$push0=, $6, $pop72
	br_if   	0, $pop0
	i32.load8_s	$push77=, 0($4)
	tee_local	$push76=, $3=, $pop77
	i32.const	$push75=, -97
	i32.add 	$push2=, $pop76, $pop75
	i32.const	$push74=, 255
	i32.and 	$push3=, $pop2, $pop74
	i32.const	$push73=, 25
	i32.gt_u	$push4=, $pop3, $pop73
	br_if   	1, $pop4
...
.LBB2_4:
	...
	i64.const	$8=, 0
	i64.const	$push79=, 11
	i64.le_u	$push1=, $6, $pop79
	br_if   	2, $pop1
	br      	3
.LBB2_5:
	end_block
	i32.const	$push84=, 208
	i32.add 	$push5=, $3, $pop84
	i32.const	$push83=, 0
	i32.const	$push82=, -49
	i32.add 	$push6=, $3, $pop82
	i32.const	$push81=, 255
	i32.and 	$push7=, $pop6, $pop81
	i32.const	$push80=, 5
	i32.lt_u	$push8=, $pop7, $pop80
	i32.select	$3=, $pop5, $pop83, $pop8
.LBB2_6:
	end_block
	i64.extend_u/i32	$push9=, $3
	i64.const	$push86=, 56
	i64.shl 	$push10=, $pop9, $pop86
	i64.const	$push85=, 56
	i64.shr_s	$8=, $pop10, $pop85
.LBB2_7:
	end_block
	i64.const	$push88=, 31
	i64.and 	$push12=, $8, $pop88
	i64.const	$push87=, 4294967295
	i64.and 	$push11=, $5, $pop87
...
.LBB2_8:
	...
	i64.or  	$7=, $8, $7
	i64.const	$push92=, -5
	i64.add 	$push91=, $5, $pop92
	tee_local	$push90=, $5=, $pop91
	i64.const	$push89=, -6
	i64.ne  	$push13=, $pop90, $pop89
	br_if   	0, $pop13
	end_loop
	block   	
	i64.ne  	$push14=, $7, $1
...
.LBB2_11:
	...
	block   	
	i64.const	$push95=, 9
	i64.gt_u	$push15=, $6, $pop95
	br_if   	0, $pop15
	i32.load8_s	$push100=, 0($4)
	tee_local	$push99=, $3=, $pop100
	i32.const	$push98=, -97
	i32.add 	$push17=, $pop99, $pop98
	i32.const	$push97=, 255
	i32.and 	$push18=, $pop17, $pop97
	i32.const	$push96=, 25
	i32.gt_u	$push19=, $pop18, $pop96
	br_if   	1, $pop19
...
.LBB2_15:
	...
	i32.add 	$push21=, $3, $pop105
	i32.const	$push104=, 255
	i32.and 	$push22=, $pop21, $pop104
	i32.const	$push103=, 5
	i32.lt_u	$push23=, $pop22, $pop103
	i32.select	$3=, $pop20, $pop106, $pop23
.LBB2_16:
	end_block
	i64.extend_u/i32	$push24=, $3
	i64.const	$push109=, 56
	i64.shl 	$push25=, $pop24, $pop109
	i64.const	$push108=, 56
	i64.shr_s	$8=, $pop25, $pop108
.LBB2_17:
	end_block
	i64.const	$push111=, 31
	i64.and 	$push27=, $8, $pop111
	i64.const	$push110=, 4294967295
	i64.and 	$push26=, $5, $pop110
...
.LBB2_18:
	...
	i64.or  	$7=, $8, $7
	i64.const	$push115=, -5
	i64.add 	$push114=, $5, $pop115
	tee_local	$push113=, $5=, $pop114
	i64.const	$push112=, -6
	i64.ne  	$push28=, $pop113, $pop112
	br_if   	0, $pop28
	end_loop
	block   	
	i64.ne  	$push29=, $7, $2
	br_if   	0, $pop29
	i32.const	$push68=, 270
	i32.add 	$push69=, $9, $pop68
	i32.const	$push52=, 2
	i32.call	$drop=, read_action_data@FUNCTION, $pop69, $pop52
	i32.const	$push53=, 256
	i32.call	$push121=, read_action_data@FUNCTION, $9, $pop53
	tee_local	$push120=, $4=, $pop121
	i32.const	$push54=, 255
	i32.const	$push119=, 255
	i32.lt_u	$push55=, $4, $pop119
	i32.select	$push56=, $pop120, $pop54, $pop55
	i32.add 	$push57=, $9, $pop56
	i32.const	$push58=, 0
	i32.store8	0($pop57), $pop58
	i32.load8_s	$push60=, 0($9)
	i32.const	$push118=, 2
	i32.or  	$push59=, $9, $pop118
