...
_ZN5eosio11multi_indexILy4805230851241541632EN8identity8contractILy8238557868240928768EE7certrowEJNS_10indexed_byILy4590200209379688448EN5boost11multi_index13const_mem_funIS4_NS_9fixed_keyILj32EEEXadL_ZNKS4_7get_keyEvEEEEEEEE6modifyIZNS3_2onERKNS3_8certpropEEUlRS4_E_EEvRKS4_yOT_:
	.param  	i32, i32, i64, i32
	.local  	i64, i32, i32, i64, i32, i64, i32, i32
	i32.const	$push65=, 0
	i32.const	$push62=, 0
	...
	copy_local	$push96=, $11
	tee_local	$push95=, $10=, $pop96
	i64.store	80($pop95), $2
	i32.load	$push1=, 60($1)
	i32.eq  	$push2=, $pop1, $0
	...
	call    	eosio_assert@FUNCTION, $pop94, $pop8
	i32.const	$push69=, 48
	i32.add 	$push70=, $10, $pop69
	i32.const	$push93=, 24
	i32.add 	$push9=, $pop70, $pop93
	i64.store	0($pop9), $4
	i64.const	$push92=, 0
	i64.store	64($10), $pop92
	i64.store	56($10), $9
	i64.store	48($10), $7
	i32.load	$push10=, 0($3)
	i32.load8_u	$push11=, 44($pop10)
	i32.store8	32($1), $pop11
	i64.load	$push91=, 0($1)
	tee_local	$push90=, $9=, $pop91
	i64.store	40($10), $pop90
	i32.const	$push12=, 36
	i32.add 	$push89=, $1, $pop12
	tee_local	$push88=, $8=, $pop89
	i32.load	$push13=, 0($3)
	i32.const	$push14=, 8
	i32.add 	$push15=, $pop13, $pop14
	i32.call	$drop=, _ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEaSERKS5_@FUNCTION, $pop88, $pop15
	block   	
	i32.const	$push16=, 48
	i32.add 	$push87=, $1, $pop16
	tee_local	$push86=, $6=, $pop87
	i32.load	$push85=, 0($3)
	tee_local	$push84=, $3=, $pop85
	i32.const	$push17=, 20
	i32.add 	$push83=, $pop84, $pop17
	tee_local	$push82=, $5=, $pop83
	i32.eq  	$push18=, $pop86, $pop82
	br_if   	0, $pop18
	i32.load	$push21=, 0($5)
	i32.const	$push99=, 24
	i32.add 	$push19=, $3, $pop99
	i32.load	$push20=, 0($pop19)
	call    	_ZNSt3__16vectorIcNS_9allocatorIcEEE6assignIPcEENS_9enable_ifIXaasr21__is_forward_iteratorIT_EE5valuesr16is_constructibleIcNS_15iterator_traitsIS7_E9referenceEEE5valueEvE4typeES7_S7_@FUNCTION, $6, $pop21, $pop20
.LBB17_2:
	end_block
	i64.load	$push22=, 0($1)
	i64.eq  	$push23=, $9, $pop22
	i32.const	$push24=, .L.str.17
	call    	eosio_assert@FUNCTION, $pop23, $pop24
	i32.const	$push26=, 40
	i32.add 	$push27=, $1, $pop26
	i32.load	$push28=, 0($pop27)
	i32.load8_u	$push105=, 0($8)
	tee_local	$push104=, $3=, $pop105
	i32.const	$push103=, 1
	i32.shr_u	$push25=, $pop104, $pop103
	i32.const	$push102=, 1
	i32.and 	$push0=, $3, $pop102
	i32.select	$push101=, $pop28, $pop25, $pop0
	tee_local	$push100=, $8=, $pop101
	i64.extend_u/i32	$7=, $pop100
	i32.const	$3=, 25
.LBB17_3:
	loop    	
	i32.const	$push110=, 1
...
.LBB17_6:
	...
	i32.load	$push114=, 0($pop31)
	tee_local	$push113=, $8=, $pop114
	i32.add 	$push32=, $3, $pop113
	i32.const	$push33=, 8
	i32.add 	$push34=, $pop32, $pop33
	i32.const	$push35=, 48
	i32.add 	$push36=, $1, $pop35
	i32.load	$push112=, 0($pop36)
	tee_local	$push111=, $6=, $pop112
	i32.sub 	$3=, $pop34, $pop111
	i32.sub 	$push37=, $8, $6
	i64.extend_u/i32	$7=, $pop37
.LBB17_7:
	loop    	
	i32.const	$push119=, 1
	i32.add 	$3=, $3, $pop119
	i64.const	$push118=, 7
	i64.shr_u	$push117=, $7, $pop118
	tee_local	$push116=, $7=, $pop117
	i64.const	$push115=, 0
	i64.ne  	$push38=, $pop116, $pop115
	br_if   	0, $pop38
	end_loop
	block   	
	block   	
...
.LBB17_10:
	...
	i32.sub 	$push121=, $11, $pop44
	tee_local	$push120=, $8=, $pop121
	copy_local	$push81=, $pop120
	i32.store	__stack_pointer($pop61), $pop81
.LBB17_11:
	end_block
	i32.store	28($10), $8
	i32.store	24($10), $8
	i32.add 	$push45=, $8, $3
	i32.store	32($10), $pop45
	i32.const	$push71=, 24
	i32.add 	$push72=, $10, $pop71
	i32.call	$drop=, _ZN8identitylsIN5eosio10datastreamIPcEEEERT_S6_RKNS_8contractILy8238557868240928768EE7certrowE@FUNCTION, $pop72, $1
	i32.load	$push46=, 64($1)
	call    	db_update_i64@FUNCTION, $pop46, $2, $8, $3
	block   	
	i32.const	$push47=, 513
	i32.lt_u	$push48=, $3, $pop47
	br_if   	0, $pop48
...
.LBB17_13:
	end_block
	block   	
	i64.load	$push49=, 16($0)
	i64.lt_u	$push50=, $9, $pop49
	br_if   	0, $pop50
	i32.const	$push57=, 16
	i32.add 	$push58=, $0, $pop57
	i64.const	$push55=, -2
	i64.const	$push53=, 1
	i64.add 	$push54=, $9, $pop53
	i64.const	$push51=, -3
	i64.gt_u	$push52=, $9, $pop51
...
_ZZN5eosio11multi_indexILy4805230851241541632EN8identity8contractILy8238557868240928768EE7certrowEJNS_10indexed_byILy4590200209379688448EN5boost11multi_index13const_mem_funIS4_NS_9fixed_keyILj32EEEXadL_ZNKS4_7get_keyEvEEEEEEEE7emplaceIZNS3_2onERKNS3_8certpropEEUlRS4_E0_EENSD_14const_iteratorEyOT_ENKUlRSL_E_clINSD_4itemEEEDaSN_:
	.param  	i32, i32
	.local  	i32, i32, i32, i64, i64, i64, i64, i64, i64, i32, i32, i32, i32
	i32.const	$push77=, 0
	i32.load	$push78=, __stack_pointer($pop77)
	i32.const	$push79=, 48
	i32.sub 	$push100=, $pop78, $pop79
	tee_local	$push99=, $14=, $pop100
	copy_local	$13=, $pop99
	i32.const	$push80=, 0
	i32.store	__stack_pointer($pop80), $14
	i32.load	$push98=, 4($0)
	tee_local	$push97=, $11=, $pop98
	i32.load	$push1=, 0($pop97)
	...
	i32.load	$2=, 0($0)
	i32.load	$push5=, 8($11)
	i64.load8_u	$push6=, 0($pop5)
	i64.store	16($1), $pop6
	i32.load	$push7=, 12($11)
	...
	i32.const	$push11=, 36
	i32.add 	$push96=, $1, $pop11
	tee_local	$push95=, $12=, $pop96
	i32.load	$push12=, 4($11)
	i32.const	$push13=, 8
	i32.add 	$push14=, $pop12, $pop13
	i32.call	$drop=, _ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEEaSERKS5_@FUNCTION, $pop95, $pop14
	block   	
	i32.const	$push15=, 48
	i32.add 	$push94=, $1, $pop15
	tee_local	$push93=, $4=, $pop94
	i32.load	$push92=, 4($11)
	tee_local	$push91=, $11=, $pop92
	i32.const	$push16=, 20
	i32.add 	$push90=, $pop91, $pop16
	tee_local	$push89=, $3=, $pop90
	i32.eq  	$push17=, $pop93, $pop89
	br_if   	0, $pop17
	i32.load	$push21=, 0($3)
	i32.const	$push18=, 24
	i32.add 	$push19=, $11, $pop18
	i32.load	$push20=, 0($pop19)
	call    	_ZNSt3__16vectorIcNS_9allocatorIcEEE6assignIPcEENS_9enable_ifIXaasr21__is_forward_iteratorIT_EE5valuesr16is_constructibleIcNS_15iterator_traitsIS7_E9referenceEEE5valueEvE4typeES7_S7_@FUNCTION, $4, $pop21, $pop20
.LBB30_2:
	end_block
	i32.const	$push23=, 40
	i32.add 	$push24=, $1, $pop23
	i32.load	$push25=, 0($pop24)
	i32.load8_u	$push106=, 0($12)
	tee_local	$push105=, $11=, $pop106
	i32.const	$push104=, 1
	i32.shr_u	$push22=, $pop105, $pop104
	i32.const	$push103=, 1
	i32.and 	$push0=, $11, $pop103
	i32.select	$push102=, $pop25, $pop22, $pop0
	tee_local	$push101=, $12=, $pop102
	i64.extend_u/i32	$10=, $pop101
	i32.const	$11=, 25
.LBB30_3:
	loop    	
	i32.const	$push111=, 1
	i32.add 	$11=, $11, $pop111
	i64.const	$push110=, 7
	i64.shr_u	$push109=, $10, $pop110
	tee_local	$push108=, $10=, $pop109
	i64.const	$push107=, 0
	i64.ne  	$push26=, $pop108, $pop107
	br_if   	0, $pop26
	end_loop
	block   	
	i32.eqz 	$push128=, $12
...
.LBB30_6:
	...
	i32.load	$push115=, 0($pop28)
	tee_local	$push114=, $12=, $pop115
	i32.add 	$push29=, $11, $pop114
	i32.const	$push30=, 8
	i32.add 	$push31=, $pop29, $pop30
	i32.const	$push32=, 48
	i32.add 	$push33=, $1, $pop32
	i32.load	$push113=, 0($pop33)
	tee_local	$push112=, $4=, $pop113
	i32.sub 	$11=, $pop31, $pop112
	i32.sub 	$push34=, $12, $4
	i64.extend_u/i32	$10=, $pop34
.LBB30_7:
	loop    	
	i32.const	$push120=, 1
	i32.add 	$11=, $11, $pop120
	i64.const	$push119=, 7
	i64.shr_u	$push118=, $10, $pop119
	tee_local	$push117=, $10=, $pop118
	i64.const	$push116=, 0
	i64.ne  	$push35=, $pop117, $pop116
	br_if   	0, $pop35
	end_loop
	block   	
	block   	
	i32.const	$push36=, 513
	i32.lt_u	$push37=, $11, $pop36
	br_if   	0, $pop37
	i32.call	$12=, malloc@FUNCTION, $11
	br      	1
.LBB30_10:
	end_block
	i32.const	$push76=, 0
	...
	i32.sub 	$push122=, $14, $pop41
	tee_local	$push121=, $12=, $pop122
	copy_local	$push88=, $pop121
	i32.store	__stack_pointer($pop76), $pop88
.LBB30_11:
	end_block
	i32.store	4($13), $12
	i32.store	0($13), $12
	i32.add 	$push42=, $12, $11
	i32.store	8($13), $pop42
	i32.call	$drop=, _ZN8identitylsIN5eosio10datastreamIPcEEEERT_S6_RKNS_8contractILy8238557868240928768EE7certrowE@FUNCTION, $13, $1
	i64.load	$push43=, 8($2)
	i64.const	$push46=, 4805230851241541632
	i32.load	$push44=, 8($0)
	i64.load	$push45=, 0($pop44)
	i64.load	$push124=, 0($1)
	tee_local	$push123=, $10=, $pop124
	i32.call	$push47=, db_store_i64@FUNCTION, $pop43, $pop46, $pop45, $pop123, $12, $11
	i32.store	64($1), $pop47
	block   	
	i32.const	$push48=, 513
	i32.lt_u	$push49=, $11, $pop48
	br_if   	0, $pop49
	call    	free@FUNCTION, $12
.LBB30_13:
	end_block
	block   	
	i64.load	$push50=, 16($2)
	i64.lt_u	$push51=, $10, $pop50
	br_if   	0, $pop51
	i32.const	$push58=, 16
	i32.add 	$push59=, $2, $pop58
	i64.const	$push56=, -2
	i64.const	$push54=, 1
	i64.add 	$push55=, $10, $pop54
	i64.const	$push52=, -3
	i64.gt_u	$push53=, $10, $pop52
	i64.select	$push57=, $pop56, $pop55, $pop53
	i64.store	0($pop59), $pop57
.LBB30_15:
	end_block
	i32.const	$push60=, 8
	...
	call    	eosio_assert@FUNCTION, $pop70, $pop69
	i32.const	$push84=, 16
	i32.add 	$push85=, $13, $pop84
	i32.const	$push125=, 24
	i32.add 	$push71=, $pop85, $pop125
	i64.store	0($pop71), $9
	i64.const	$push72=, 0
	i64.store	32($13), $pop72
	i64.store	24($13), $8
	i64.store	16($13), $7
	...
	i32.const	$push73=, 2
	i32.call	$push75=, db_idx256_store@FUNCTION, $10, $pop74, $5, $6, $pop87, $pop73
	i32.store	68($1), $pop75
	i32.const	$push83=, 0
	i32.const	$push81=, 48
...
.LBB51_6:
	...
	.endfunc
.Lfunc_end51:
	.size	_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEE6resizeEjc, .Lfunc_end51-_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEE6resizeEjc
...
.LBB52_15:
	...
	.endfunc
.Lfunc_end52:
	.size	_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEE6appendEjc, .Lfunc_end52-_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEE6appendEjc
...
.LBB53_14:
	...
	.endfunc
.Lfunc_end53:
	.size	_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEE9__grow_byEjjjjjj, .Lfunc_end53-_ZNSt3__112basic_stringIcNS_11char_traitsIcEENS_9allocatorIcEEE9__grow_byEjjjjjj
...
.LBB55_5:
	...
	.endfunc
.Lfunc_end55:
	.size	memcmp, .Lfunc_end55-memcmp
