...
(module
 ...
 (table 4 4 anyfunc)
 (elem (i32.const 0) $__wasm_nullptr $_ZN5eosio5token8transferEyyNS_5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE $_ZN5eosio5token6createEyNS_5assetEhhh $_ZN5eosio5token5issueEyNS_5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE)
 (memory $0 1)
 (data (i32.const 4) "`5\00\00")
 ...
 (data (i32.const 352) "issue\00")
 (data (i32.const 368) "invalid quantity\00")
 (data (i32.const 400) "must issue positive quantity\00")
 ...
 (data (i32.const 640) "must transfer positive quantity\00")
 (data (i32.const 672) "overdrawn balance\00")
 (data (i32.const 704) "account is frozen by issuer\00")
 (data (i32.const 736) "all transfers are frozen by issuer\00")
 (data (i32.const 784) "account is not white listed\00")
 (data (i32.const 816) "issuer may not recall token\00")
 (data (i32.const 848) "insufficient authority\00")
 (data (i32.const 880) "unable to find key\00")
 (data (i32.const 912) "can only transfer to white listed accounts\00")
 (data (i32.const 960) "receiver requires whitelist by issuer\00")
 ...
 (func $_ZN5eosio5token5issueEyNS_5assetENSt3__112basic_stringIcNS2_11char_traitsIcEENS2_9allocatorIcEEEE (type $FUNCSIG$vijii) (param $0 i32) (param $1 i64) (param $2 i32) (param $3 i32)
  ...
  (block $label$6
   ...
   (call $_ZN5eosio15dispatch_inlineINS_5tokenEJyyNS_5assetENSt3__112basic_stringIcNS3_11char_traitsIcEENS3_9allocatorIcEEEEEEEvNS_16permission_levelEyyMT_FvDpT0_ENS3_5tupleIJSD_EEE
    (i32.add
     (get_local $14)
     (i32.const 16)
    )
 ...
 (func $_ZN5eosio15dispatch_inlineINS_5tokenEJyyNS_5assetENSt3__112basic_stringIcNS3_11char_traitsIcEENS3_9allocatorIcEEEEEEEvNS_16permission_levelEyyMT_FvDpT0_ENS3_5tupleIJSD_EEE (param $0 i32) (param $1 i64) (param $2 i64) (param $3 i32) (param $4 i32)
  (local $5 i32)
  (local $6 i32)
  (local $7 i32)
  (i32.store offset=4
